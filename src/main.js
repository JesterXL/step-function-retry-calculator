...
var $author$project$Main$calculateTimes = function (model) {
	if (model.t < 1) {
		...
		var values = A2(
			...
			F2(
				function (index, _v0) {
					return ((model.s * model.x) * index) + model.s;
				}),
			A2($elm$core$List$repeat, model.t, 0));
		return _Utils_update(
			model,
			{B: values});
	}
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_Nil,
							A2($elm$core$List$map, $author$project$Main$viewTime, model.B)))
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$viewBlankForZeroElseNumber(model.s)),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$type_('text'),
						$elm$html$Html$Attributes$value(
						$author$project$Main$viewBlankForZeroElseNumber(model.t)),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$type_('text'),
						$elm$html$Html$Attributes$value(
						$author$project$Main$viewBlankForZeroElseNumber(model.x)),
